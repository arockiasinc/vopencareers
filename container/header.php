...
<body class="bg-jet-cream font-jet text-jet-charcoal antialiased">
  <header class="sticky top-0 z-50 border-b border-black/5 bg-jet-cream/95 backdrop-blur">
    <div class="mx-auto flex max-w-[1440px] items-center justify-between gap-4 px-4 py-4 sm:px-6 lg:px-10">
      ...
      <div class="hidden items-center gap-3 md:flex">
        ...
        <a href="#" target="_blank" rel="noreferrer" class="rounded-full bg-jet-charcoal px-6 py-3 text-[17px] font-semibold text-white transition hover:bg-black">
          Saved Jobs (0)
        </a>
      </div>
    ...
    <div id="mobile-menu" class="hidden border-t border-black/5 bg-jet-cream lg:hidden">
      <nav class="mx-auto flex max-w-[1440px] flex-col gap-2 px-4 py-5 text-lg font-semibold sm:px-6" aria-label="Mobile">
        <a class="rounded-2xl px-4 py-3 transition hover:bg-white" href="index.php#top">Home</a>
        <a class="rounded-2xl px-4 py-3 transition hover:bg-white" href="search-results.php">Search Jobs</a>
        <a class="rounded-2xl px-4 py-3 transition hover:bg-white" href="index.php#culture">Teams</a>
        <a class="rounded-2xl px-4 py-3 transition hover:bg-white" href="about-us.php">Our Company</a>
        ...
        <div class="mt-3 grid grid-cols-1 gap-3 sm:grid-cols-2">
          ...
          <a href="#" target="_blank" rel="noreferrer" class="rounded-full bg-jet-charcoal px-6 py-3 text-center text-base font-semibold text-white">
            Saved Jobs (0)
          </a>
        </div>
      </nav>
